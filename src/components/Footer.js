                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-2 ml-auto">
                            ...
                            <div className="social-section text-md-left">
                                <ul className="text-center">
                                    <li>
                                        <a className="btn-floating  btn-fb waves-effect waves-light" href="#section">
                                            <i className="fa fa-facebook"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-ins waves-effect waves-light" href="#section">
                                            <i className="fa fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-tw waves-effect waves-light" href="#section">
                                            <i className="fa fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-yt waves-effect waves-light" href="#section">
                                            <i className="fa fa-youtube"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-li waves-effect waves-light" href="#section">
                                            <i className="fa fa-linkedin"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-dribbble waves-effect waves-light" href="#section">
                                            <i className="fa fa-dribbble left"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-pin waves-effect waves-light" href="#section">
                                            <i className="fa fa-pinterest"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-gplus waves-effect waves-light" href="#section">
                        ...
                        <div className="col-lg-2">
                            ...
                            <ul>
                                <li>
                                    <a href="#section">Store Delivery</a>
                                </li>
                                <li>
                                    <a href="#section">Online Delivery</a>
                                </li>
                                <li>
                                    <a href="#section">Delivery Terms &amp; Conditions</a>
                                </li>
                                <li>
                                    <a href="#section">Tracking</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-2">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#section">Return Policy</a>
                                </li>
                                <li>
                                    <a href="#section">Product Registration</a>
                                </li>
                            </ul>
